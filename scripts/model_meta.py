...
sys.path.append("third_party/models/research/slim/nets/mobilenet/")
...
NETS = {
    ...
    #     'model': nets.mobilenet_v1.mobilenet_v1,
    ...
    #     'output_names': ['MobilenetV1/Logits/SpatialSqueeze'],
    #     'checkpoint_filename': CHECKPOINT_DIR + 
    #         'mobilenet_v1_1.0_192.ckpt',
    #     'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v1_1p0_192.pb',
    #     'plan_filename': PLAN_DIR + 'mobilenet_v1_1p0_192.plan',
    #     'preprocess_fn': preprocess_inception,
    #     'postprocess_fn': postprocess_inception,
    # },

    # 'mobilenet_v1_1p0_160': {
    #     'model': nets.mobilenet_v1.mobilenet_v1,
    #     'arg_scope': nets.mobilenet_v1.mobilenet_v1_arg_scope,
    #     'num_classes': 1001,
    #     'input_name': 'input',
    ...
    #     'output_names': ['MobilenetV1/Logits/SpatialSqueeze'],
    #     'checkpoint_filename': CHECKPOINT_DIR + 
    #         'mobilenet_v1_1.0_160.ckpt',
    #     'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v1_1p0_160.pb',
    #     'plan_filename': PLAN_DIR + 'mobilenet_v1_1p0_160.plan',
    #     'preprocess_fn': preprocess_inception,
    #     'postprocess_fn': postprocess_inception,
    # },

    # 'mobilenet_v1_1p0_128': {
    #     'model': nets.mobilenet_v1.mobilenet_v1,
    #     'arg_scope': nets.mobilenet_v1.mobilenet_v1_arg_scope,
    #     'num_classes': 1001,
    #     'input_name': 'input',
    ...
    #     'output_names': ['MobilenetV1/Logits/SpatialSqueeze'],
    #     'checkpoint_filename': CHECKPOINT_DIR + 
    #         'mobilenet_v1_1.0_128.ckpt',
    #     'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v1_1p0_128.pb',
    #     'plan_filename': PLAN_DIR + 'mobilenet_v1_1p0_128.plan',
    #     'preprocess_fn': preprocess_inception,
    #     'postprocess_fn': postprocess_inception,
    # },
    ...
    #     'model': nets.mobilenet_v1.mobilenet_v1_050,
    #     'arg_scope': nets.mobilenet_v1.mobilenet_v1_arg_scope,
    #     'num_classes': 1001,
    #     'input_name': 'input',
    #     'input_width': 160,
    ...
    #     'model': nets.mobilenet_v1.mobilenet_v1_025,
    #     'arg_scope': nets.mobilenet_v1.mobilenet_v1_arg_scope,
    #     'num_classes': 1001,
    #     'input_name': 'input',
    #     'input_width': 128,
    ...
    'mobilenet_v2_1p0_224': {
        ...
        'input_height': 224,
        'input_channels': 3,
        'output_names': ['MobilenetV2/Logits/output'],
        'checkpoint_filename': CHECKPOINT_DIR + 
    ...
    'mobilenet_v2_1p0_192': {
        ...
        'output_names': ['MobilenetV2/Logits/output'],
        'checkpoint_filename': CHECKPOINT_DIR + 
            'mobilenet_v2_1.0_192.ckpt',
        'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v2_1p0_192.pb',
        'plan_filename': PLAN_DIR + 'mobilenet_v2_1p0_192.plan',
        'preprocess_fn': preprocess_inception,
        'postprocess_fn': postprocess_inception,
    },

    'mobilenet_v2_1p0_160': {
        'model': mobilenet_v2.mobilenet,
        'arg_scope': mobilenet_v2.training_scope,
        'num_classes': 1001,
        'input_name': 'input',
        ...
        'output_names': ['MobilenetV2/Logits/output'],
        'checkpoint_filename': CHECKPOINT_DIR + 
            'mobilenet_v2_1.0_160.ckpt',
        'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v2_1p0_160.pb',
        'plan_filename': PLAN_DIR + 'mobilenet_v2_1p0_160.plan',
        'preprocess_fn': preprocess_inception,
        'postprocess_fn': postprocess_inception,
    },

    'mobilenet_v2_1p0_128': {
        'model': mobilenet_v2.mobilenet,
        'arg_scope': mobilenet_v2.training_scope,
        'num_classes': 1001,
        'input_name': 'input',
        ...
        'output_names': ['MobilenetV2/Logits/output'],
        'checkpoint_filename': CHECKPOINT_DIR + 
            'mobilenet_v2_1.0_128.ckpt',
        'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v2_1p_128.pb',
        'plan_filename': PLAN_DIR + 'mobilenet_v2_1p0_128.plan',
        'preprocess_fn': preprocess_inception,
        'postprocess_fn': postprocess_inception,
    },
    ...
    'mobilenet_v2_1p0_96': {
        ...
        'output_names': ['MobilenetV2/Logits/output'],
        'checkpoint_filename': CHECKPOINT_DIR + 
            'mobilenet_v2_1.0_96.ckpt',
        'frozen_graph_filename': FROZEN_GRAPHS_DIR + 'mobilenet_v2_1p_96.pb',
        'plan_filename': PLAN_DIR + 'mobilenet_v2_1p0_96.plan',
        'preprocess_fn': preprocess_inception,
        'postprocess_fn': postprocess_inception,
    },
}
